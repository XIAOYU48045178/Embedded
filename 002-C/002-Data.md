...
`float 类型通常占用 4 字节 32 位 能表示大约 7 位有效数字的浮点数 范围约为 3.4E-38 到 3.4E+38 有符号`

`double 类型通常占用 8 字节 64 位  提供大约 15 位有效数字 范围扩展至约 2.3E-308 到 1.7E+308`
...
`char -> int -> unsigned int -> long -> double`
